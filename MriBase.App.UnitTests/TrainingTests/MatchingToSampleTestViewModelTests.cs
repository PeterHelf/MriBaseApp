...
{
    internal class MatchingToSampleTestViewModelTests
    {
        private MockContainer container;
        private MockTrainingViewModelSelectionService trainingViewModelSelectionService;
        private Training training;
        private TestableMatchingToSampleTestViewModel trainingViewModel;
        ...
        public void Setup()
        {
            ...
            this.training = trainingCreationService.CreateDefaultMatchinToSampleTraining();
            ...
            this.trainingViewModel = trainingViewModelSelectionService.GetTrainingViewModel(training) as TestableMatchingToSampleTestViewModel;
        }
