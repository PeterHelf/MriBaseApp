...
{
    internal class RandomPositionTestViewModelTests
    {
        private MockContainer container;
        private MockTrainingViewModelSelectionService trainingViewModelSelectionService;
        private Training training;
        private TestableRandomPositionTestViewModel trainingViewModel;
        ...
        public void Setup()
        {
            ...
            this.training = trainingCreationService.CreateDefaultRandomPostionTraining();
            ...
            this.trainingViewModel = trainingViewModelSelectionService.GetTrainingViewModel(training) as TestableRandomPositionTestViewModel;
        }
